    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative border-t border-border/40 px-5 py-32">
        <div className="mx-auto max-w-6xl">
          ...
          {/* Three-pillar bento — kinetic glass */}
          <div className="relative mt-20">
            {/* Ambient drifting glow behind grid */}
            <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
              <div className="absolute left-1/4 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-[120px] animate-pulse" />
              <div className="absolute right-1/4 top-1/3 h-64 w-64 rounded-full bg-primary/5 blur-[100px]" />
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {[
                ...
                },
                {
                  ...
                  stat: "$CHAD",
                  statLabel: "+ on every fill",
                },
              ].map(({ icon: Icon, num, kicker, t, d, stat, statLabel }) => (
                <article
                  key={t}
                  className="group relative flex h-[420px] flex-col justify-between overflow-hidden rounded-3xl border border-border/60 bg-card/40 p-8 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-primary/50 hover:shadow-[0_20px_60px_-20px_hsl(var(--primary)/0.35)]"
                >
                  {/* Radial hover glow */}
                  <div
                    aria-hidden
                    ...
                    style={{
                      background:
                        "radial-gradient(circle at 0% 0%, hsl(var(--primary) / 0.12), transparent 55%)",
                    }}
                  />
                  ...
                  <div className="relative z-10 flex items-start justify-between">
                    <div className="flex items-baseline gap-2">
                      <span className="font-mono text-3xl font-semibold text-primary">{num}</span>
                      <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
                        / {kicker}
                      </span>
                    </div>
                    <div className="flex h-11 w-11 items-center justify-center rounded-full border border-border/80 bg-background/60 transition-colors duration-500 group-hover:border-primary/60 group-hover:bg-primary/10">
                      <Icon className="h-5 w-5 text-foreground/80 transition-colors group-hover:text-primary" />
                    </div>
                  </div>

                  {/* Body */}
                  <div className="relative z-10">
                    <h3 className="font-display text-3xl md:text-[2rem] font-semibold leading-[1.05] tracking-tight">
                      {t}
                    </h3>
          ...
          {/* Closing strip — definitive CTA */}
          <div className="group relative mt-5 overflow-hidden rounded-3xl border border-border/60 bg-card/40 p-8 backdrop-blur-sm transition-all duration-500 hover:border-primary/50">
            <div
              aria-hidden
              className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100"
              style={{
                background:
                  "radial-gradient(circle at 100% 50%, hsl(var(--primary) / 0.15), transparent 60%)",
              }}
            />
            <div className="relative z-10 flex flex-wrap items-center justify-between gap-6">
              <div>
                ...
                <div className="mt-2 font-display text-2xl md:text-3xl font-semibold tracking-tight">
                  No chains. No gas confusion.{" "}
                  <span className="text-muted-foreground">No cope.</span>
                </div>
              </div>
              <Link
                to="/trade/$mint"
                params={{ mint: "So11111111111111111111111111111111111111112" }}
                className="inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition-all hover:gap-3 hover:bg-primary/90 hover:shadow-[0_10px_40px_-10px_hsl(var(--primary)/0.6)]"
              >
                Start hunting
