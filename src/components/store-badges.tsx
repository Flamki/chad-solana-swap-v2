...
function PlayStoreLogo({ className = "h-5 w-5" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M3.609 1.814L13.792 12 3.61 22.186c-.175-.1-.318-.293-.318-.52V2.334c0-.227.143-.42.318-.52z" fill="#EA4335" />
      <path d="M17.017 12l-7.92-7.573 6.89 4.043 4.606 4.606-.005.005-.005.005-3.566-3.566z" fill="#FBBC05" />
      <path d="M14.5 10.5l4.103-4.102L6.975 1.058l7.525 9.442z" fill="#4285F4" />
      <path d="M14.603 13.397l-4.603 4.603 5.126 3.006c.38.222.865-.04.865-.51V13.06c0-.45-.45-.71-.848-.51l-.54.317z" fill="#34A853" />
    </svg>
  );
}
