...
export function PriceChart({
  ...
  const [chartEngine, setChartEngine] = useState<ChartEngine>(
    geckoPoolAddress ? "geckoterminal" : "chadwallet",
  );
  ...
  const chartEngineOptions: Array<[ChartEngine, string]> = geckoPoolAddress
    ? [
        ["geckoterminal", "Gecko"],
        ["chadwallet", "Live"],
      ]
  ...
  useEffect(() => {
    setChartEngine(geckoPoolAddress ? "geckoterminal" : "chadwallet");
  }, [token.mint, geckoPoolAddress]);
